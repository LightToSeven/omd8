...
// symbols:
		...
		(lib.вамамыыыы_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.shape).wait(5).to({x: 12.175, y: 14.375}, 0).wait(5).to({
				x: 9.675,
				y: -0.625
			}, 0).wait(5));
		...
		(lib.вамамавм_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				scaleY: 1.2232,
				x: 14.35
			}, 15).to({scaleX: 1, scaleY: 1, x: 14.3}, 15).wait(1));
		...
		(lib.pers1_Layer_12 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				x: 49.7,
				y: 14.8
			}, 9, cjs.Ease.quadInOut).to({x: 54.2, y: 6.2}, 10, cjs.Ease.quadInOut).wait(1));
		...
		(lib.pers1_Layer_9 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				skewX: -3.5711,
				x: 8.35
			}, 9, cjs.Ease.quadInOut).to({regX: 8.4, skewX: 3.5711, x: 8.4}, 10, cjs.Ease.quadInOut).wait(1));
		...
		(lib.hjsgdfjhgsdhvj_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				skewX: -8.0917,
				y: 46.55
			}, 14).to({scaleY: 1, skewX: 0, y: 46.5}, 15).wait(1));
		...
		(lib.hfgjhfg_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				skewY: 5.4329,
				y: 16.25
			}, 6).to({scaleX: 1.0048, skewY: -5.5802, y: 16.3}, 6).wait(1));
		...
		(lib.EDEDEDFFFG_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({x: 7.45, y: 20}, 15).to({
				x: 7.4,
				y: 7.5
			}, 16).wait(1));
		...
		(lib.EDEDEDFFFG_copy_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({x: 7.4, y: 7.5}, 15).to({
				x: 7.45,
				y: 20
			}, 16).wait(1));
		...
		(lib.EDEDEDED_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				x: 7.4,
				y: 10.9
			}, 9).wait(11).to({rotation: 355.7647, x: 7.55, y: 11}, 10).wait(11));
		...
		(lib.EDEDEDE_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				x: 7.45,
				y: 10.95
			}, 19).to({regY: 11, scaleX: 1, scaleY: 1, x: 7.5, y: 11}, 20).wait(1));
		...
		(lib.dccrvrc_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				scaleY: 1,
				x: 7.8
			}, 14).to({regX: 7.9, regY: 11.4, scaleX: 0.1401, scaleY: 0.1401, x: 7.85}, 15).wait(1));
		...
		(lib.ысывсвсв_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({x: 19.5, y: 6.4}, 0).wait(6).to({
				x: 17,
				y: 14.9
			}, 0).wait(6));
		...
		(lib.тиствсьтвсвсв_Layer_2 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				rotation: 10.2405,
				y: 29.25
			}, 9, cjs.Ease.quadInOut).to({rotation: 0, y: 29.2}, 10, cjs.Ease.quadInOut).wait(1));
		...
		(lib.всвсвсвсв_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				scaleX: 1,
				scaleY: 1
			}, 9, cjs.Ease.quadInOut).wait(24).to({
				regY: 11,
				scaleX: 0.0909,
				scaleY: 0.0909
			}, 9).to({_off: true}, 1).wait(23));
		...
		(lib.амамамама_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				skewX: -4.8033,
				x: 35.5
			}, 14, cjs.Ease.quadInOut).to({scaleY: 1.0014, skewX: 3.0065, x: 35.4}, 15, cjs.Ease.quadInOut).wait(1));
		...
		(lib.pesr4anim_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				scaleY: 1.0101,
				skewX: -8.0947
			}, 15, cjs.Ease.quadInOut).to({scaleY: 1.006, skewX: 6.2678}, 14, cjs.Ease.quadInOut).wait(1));
		...
		(lib.pers8_anim_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				scaleY: 1.006,
				skewX: 6.2678
			}, 15, cjs.Ease.quadInOut).to({scaleY: 1.0101, skewX: -8.0947}, 14, cjs.Ease.quadInOut).wait(1));
		...
		(lib.pers7_Layer_2 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				rotation: -11.2587,
				x: 45.1
			}, 17).to({rotation: 8.1935, x: 45.05}, 18).wait(1));
		...
		(lib.pers6_Layer_2 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				rotation: 14.9992,
				y: 26.55
			}, 5).to({regY: 10.1, rotation: -6.2539, y: 26.65}, 5).wait(1));
		...
		(lib.pers1_leg2 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				skewX: -4.6053,
				x: 53.4
			}, 9, cjs.Ease.quadInOut).to({scaleY: 1.0027, skewX: 4.1881, x: 53.35}, 10, cjs.Ease.quadInOut).wait(1));
		...
		(lib.pers1_Layer_11 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				x: 42.95,
				y: 34.1
			}, 9, cjs.Ease.quadInOut).to({rotation: 0, x: 41.3, y: 22.4}, 10, cjs.Ease.quadInOut).wait(1));
		...
		(lib.kjbdckjbdc_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({
				...
				scaleY: 0.0513,
				y: 11.55
			}, 10).to({regY: 11.5, scaleX: 1, scaleY: 1, y: 11.5}, 10).wait(1));
		...
		(lib.jump_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({
				...
				scaleY: 0.9444,
				y: 61.9
			}, 5).to({regY: 58.5, scaleY: 1, y: 38.5}, 4).to({
				regY: 58.6,
				scaleY: 0.9615,
				y: 60.9
			}, 4, cjs.Ease.get(1)).to({regY: 58.5, scaleY: 1, y: 58.5}, 2).wait(1));
		...
		(lib.hvgjhvjhv_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({skewX: -2.3923, x: 26.45}, 14).to({
				skewX: 2.3923,
				x: 26.4
			}, 15).wait(1));
		...
		(lib.pres6anim_Layer_1 = function (mode, startPosition, loop) {
			...
			this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY: 1.0005, skewX: 1.782}, 14).to({
				scaleY: 1,
				skewX: 0
			}, 15).wait(1));
...
// library properties:
		lib.properties = {
			...
			opacity: 0.00,
			manifest: [
				{src: "img/logo/Group_21_0.png", id: "Group_21_0"},
				{src: "img/logo/Group_22_0.png", id: "Group_22_0"},
				{src: "img/logo/Group_23_0.png", id: "Group_23_0"},
				{src: "img/logo/Group_24_0.png", id: "Group_24_0"},
				{src: "img/logo/Group_25_0.png", id: "Group_25_0"},
				{src: "img/logo/Group_26_0.png", id: "Group_26_0"},
				{src: "img/logo/Group_27_0.png", id: "Group_27_0"},
				{src: "img/logo/Group_28_0.png", id: "Group_28_0"},
				{src: "img/logo/Group_29_0.png", id: "Group_29_0"}
			],
			preloads: []
		};
